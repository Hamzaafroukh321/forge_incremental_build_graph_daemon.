...
Decision: Implement the production core, FIPC codec, session state, workspace model, and CLI state workflows portably. Linux socket/watcher bindings remain adapter entry points and must be validated on Linux.
