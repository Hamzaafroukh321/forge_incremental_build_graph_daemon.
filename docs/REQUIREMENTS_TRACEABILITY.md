...
| REQ-CAS-001 | 4, 8, 10, 15 | Artifact digest verification, publication, leases, filesystem reopen, GC | `include/forge/artifact.hpp`, `src/artifact/*` | `ArtifactDigestMismatchQuarantined`, `MultiArtifactCommitAtomic`, `CasGcKeepsLeases`, `DiskArtifactPublishReopens`; Docker debug/release/ASan tests pass | Verified | 54aa070, pending |
