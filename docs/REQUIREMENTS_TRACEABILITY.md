...
| REQ-WORKSPACE-001 | 8, 10, 15 | Path normalization, coalescing, stale fingerprint rejection, Linux inotify event intake | `include/forge/workspace.hpp`, `src/workspace/*` | `UnchangedContentNoInvalidation`, `StaleFingerprintIgnored`, `InotifyWatcherReportsFileChange`; Docker debug/release/ASan tests pass | Verified | 54aa070 |
